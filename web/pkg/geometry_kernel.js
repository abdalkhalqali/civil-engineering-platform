...
export class WasmSession {
    ...
    element_details(element_id) {
        ...
        try {
            ...
            const ret = wasm.wasmsession_element_details(this.__wbg_ptr, ptr0, len0);
            deferred2_0 = ret[0];
            deferred2_1 = ret[1];
    ...
    load(data) {
        ...
        try {
            ...
            const len0 = WASM_VECTOR_LEN;
            const ret = wasm.wasmsession_load(this.__wbg_ptr, ptr0, len0);
            deferred2_0 = ret[0];
            deferred2_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
     ...
     * @param {number} land_area_m2
     */
    constructor(name, project_type, land_area_m2) {
        const ptr0 = passStringToWasm0(name, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passStringToWasm0(project_type, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len1 = WASM_VECTOR_LEN;
        const ret = wasm.wasmsession_new(ptr0, len0, ptr1, len1, land_area_m2);
        this.__wbg_ptr = ret;
    ...
    redo() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.wasmsession_redo(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
    ...
    render_data() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.wasmsession_render_data(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
     ...
     */
    revision() {
        const ret = wasm.wasmsession_revision(this.__wbg_ptr);
        return ret;
    }
    /**
     ...
     */
    save() {
        const ret = wasm.wasmsession_save(this.__wbg_ptr);
    ...
    set_active_level(level_id) {
        ...
        try {
            ...
            const len0 = WASM_VECTOR_LEN;
            const ret = wasm.wasmsession_set_active_level(this.__wbg_ptr, ptr0, len0);
            deferred2_0 = ret[0];
            deferred2_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
     ...
     * @param {number} y_m
     * @param {number} z_m
     * @param {number} tolerance_m
     * @returns {string}
     */
    snap(x_m, y_m, z_m, tolerance_m) {
        let deferred1_0;
        let deferred1_1;
        try {
            const ret = wasm.wasmsession_snap(this.__wbg_ptr, x_m, y_m, z_m, tolerance_m);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
    ...
    state() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.wasmsession_state(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
    ...
    undo() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.wasmsession_undo(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
...
function __wbg_get_imports() {
    const import0 = {
        ...
        __wbg_getRandomValues_8b3a4b445d260b5f: function() { return handleError(function (arg0, arg1) {
            globalThis.crypto.getRandomValues(getArrayU8FromWasm0(arg0, arg1));
        }, arguments); },
        __wbg_getTime_2084a588a6e942d4: function(arg0) {
            const ret = arg0.getTime();
            return ret;
        },
        __wbg_new_0_aff09eb578e67eff: function() {
            const ret = new Date();
            return ret;
        },
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('geometry_kernel_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
