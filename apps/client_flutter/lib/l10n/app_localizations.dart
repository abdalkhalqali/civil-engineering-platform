...
abstract class AppLocalizations {
  ...
  /// No description provided for @testRustKernel.
  ///
  /// In ar, this message translates to:
  /// **'اختبار نواة Rust'**
  String get testRustKernel;

  /// No description provided for @kernelConnected.
  ///
  /// In ar, this message translates to:
  /// **'تم الاتصال بنواة الهندسة بنجاح.'**
  String get kernelConnected;

  /// An error raised while calling the Rust bridge.
  ///
  /// In ar, this message translates to:
  /// **'خطأ في الجسر: {error}'**
